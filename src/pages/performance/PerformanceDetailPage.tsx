				...
				<div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
					<div className="grid gap-x-12 grid-cols-3">
						...
						<div>
							...
							<div className="mt-8 aspect-[3/4] h-[500px] bg-gray-200 rounded-2xl mb-3" />
						</div>

						{/* 공연 상세 정보 */}
						<div className="mt-2 col-span-2">
							<p className="mt-28 text-sm text-gray-600">타입 : 로맨스</p>
							<p className="mt-4 text-sm text-gray-600">장르 : 오페라</p>
							<p className="mt-4 text-sm text-gray-600">공연 시간 : 130분</p>
							...
							<div className="mt-12 pt-10">
								...
								<p className="mt-4 mb-32 text-gray-700">
